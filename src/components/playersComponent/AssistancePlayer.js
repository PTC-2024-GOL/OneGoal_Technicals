...
const AssistancePlayer = ({ idJugador }) => {
    ...
    const fillPlayersAssistance = async () => {
        ...
        if (DATA.status) {
            ...
            console.log(DATA.error);
            setLoading(false); // Termina la carga si ocurre un error
        }
    };
                        ...
                        <View style={styles.rowCards}>
                            ...
                            <Card style={styles.card}>
                                <Card style={styles.cardCyan}>
                                    ...
                                    <Text style={styles.textColor} variant="displayMedium">
                                        {datosgrafica.cantidad_enfermedad}
                                    </Text>
                                </Card>
                            </Card>
                            <Card style={styles.card}>
                        ...
                        {activeTab === "historial" ? (
                            ...
                            <View>
                                ...
                                {playerStatuses
                                    .filter(
                                        (player) =>
                                            player.observacion_asistencia !== null
                                    )
                                    .map((player, index) => (
                                        <View
                                            key={index}
                                        ...
                                        >
                                            ...
                                            <TouchableOpacity
                                                style={
                                                    styles.observationButtonM
                                                }
                                                onPress={() =>
                                                    llenarObservaciones(
                                                        player.observacion_asistencia
                                                    )
                                                }
                                            >
                                                <Image
